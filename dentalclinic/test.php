		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="test.php">TESTIMONIALS</a></li>
   ...
   <div class="mission">
	<div class="container">
		<div class="row">
			...
			<div class="row">
			<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 mission-text">
				<p>Mr. Dharani Dharpan, an astrologer from West Bengal had complained of decayed teeth and replacement of missing teeth. Apollo White Dental KNK Spa did complete extraction of his teeth followed by placement of 10 Implants and Fixed Dentures.</p>
			</div>
			<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 mission-video">
				<iframe width="457" height="314" src="https://www.youtube.com/embed/7GeoZlF4JUI" allowfullscreen></iframe>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 mission-text">
				<p>Mr. Loni Sap – Managing Director of Relationship Science. The patient had come to our KNK Spa for a Filling and Scaling. He had been diagnosed with some space in between tooth and was suggested to go for a Veneer. The doctors had prepared the veneer and the entire procedure was done on the same day. The patient is highly satisfied with the services of Apollo White Dental.</p>
			</div>
			<div>
				<iframe width="457" height="314" src="https://www.youtube.com/embed/iJ66NxEXUKg" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
			</div>
		</div>
		</div>
	</div>
