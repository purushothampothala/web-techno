		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown"> <a data-toggle="dropdown" href="serives.php">SERVICES</a>
				...
				<div class="tips-content">
					<div class="tab-content">
						<div class="tab-pane fade active in tips-content-item" id="tips1">
							...
							<div class="tips-content-item-btn"> <a href="services.php" class="btn btn-primary-1">SERVICES</a> </div>
						</div>
					...
					<div class="owl-review2" id="owl-review2">
						<div>
							<div class="review-item">
								<div class="review-item-image"> <img src="images/k1.jpg" alt="" /> </div>
							...
							<div class="review-item">
								<div class="review-item-image"> <img src="images/k2.jpg" alt="" /> </div>
						...
						<div>
							<div class="review-item">
								<div class="review-item-image"> <img src="images/k3.jpg" alt="" /> </div>
