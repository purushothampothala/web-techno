				...
				<div class="blog-item">
					...
					<div class="blog-item-desc single-desc">
						...
						<div class="blog-item-text">
							...
							<p>Prevention of dental caries includes regular cleaning of the teeth, a diet low in sugar, and small amounts of fluoride.[2][4] Brushing the teeth twice per day and flossing between the teeth once a day is recommended by many.[6][4] Fluoride may be from water, salt or toothpaste among other sources.[2] Treating a mother's dental caries may decrease the risk in her children by decreasing the numbers of certain bacteria.[4] Screening can result in earlier detection.[6] Depending on the extent of destruction, various treatments can be used to restore the tooth to proper function or the tooth may be removed.[6] There is no known method to grow back large amounts of tooth.[9] The availability of treatment is often poor in the developing world.[2] Paracetamol (acetaminophen) or ibuprofen may be taken for pain.</p>
							<p>Worldwide, approximately 2.3 billion people (32% of the population) have dental caries in their permanent teeth.[7] The World Health Organization estimates that nearly all adults have dental caries at some point in time.[2] In baby teeth it affects about 620 million people or 9% of the population.[10] They have become more common in both children and adults in recent years.[11] The disease is most common in the developed world due to greater simple sugar consumption and less common in the developing world.[6] Caries is Latin for "rottenness".</p>
							<p>Tooth whitening (termed tooth bleaching when utilizing bleach), is either restoration of natural tooth shade or whitening beyond natural tooth shade, depending on the definition used.</p>
							<p>Restoration of the underlying, natural tooth shade is possible by simply removing surface (extrinsic) stains (e.g. from tea, coffee, red wine and tobacco) and calculus (tartar). This is achieved by having the teeth cleaned by a dental professional (commonly termed "scale and polish".</p>
						</div>
					</div>
					...
					<div class="blog-item-media">
						<div class="comment first-comm">
							...
							<div class="comment-body">
								...
								<div class="comment-body-text"> I have recommended several family and friends to them and all have been more than satisfied with the care and attention given. </div>
							</div>
							<div class="comment">
