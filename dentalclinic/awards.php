		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown active"> <a data-toggle="dropdown" href="#">AWARDS & MEDIA</a>
						<ul class="dropdown-menu" role="menu">
		...
		<div class="row">
			...
			<div class="blog-container">
				<div class="owl-blog" id="owl-blog"> 
					...
					<!-- BLOG ITEM -->
					<div class="blog-item">
						<div class="blog-item-image"> <img src="images/a1.jpg" alt="" />
						...
						<div class="blog-item-title">
							<h3><a href="#">Award for the free dental checkup<br>
								Dental Exams</a></h3>
						</div>
						<div class="blog-item-author"><a href="#">by Dr. Kaeden Bernard</a></div>
						<div class="blog-item-text">With the facilities of the given treatment for the patients </div>
						<!--<div class="blog-item-button"><a href=# class="btn btn-primary-1">READ MORE</a></div>-->
					</div>
					
					<!-- BLOG ITEM -->
					<div class="blog-item">
						<div class="blog-item-image"> <img src="images/a2.jpg" alt="" />
							<div class="blog-item-date"><i class="fa fa-calendar-o"></i> 03.10.2016</div>
						...
						<div class="blog-item-author"><a href="#">by Dr. Kaeden Bernard</a></div>
						<div class="blog-item-text">oraganisation of the dental care in the pune with all the staff</div>
						<!--<div class="blog-item-button"><a href=# class="btn btn-primary-1">READ MORE</a></div>-->
					</div>
					
					<!-- BLOG ITEM -->
					<div class="blog-item">
						<div class="blog-item-image"> <img src="images/a3.jpg" alt="" />
							<div class="blog-item-date"><i class="fa fa-calendar-o"></i> 03.10.2016</div>
							<div class="blog-item-comments"><i class="fa fa-comments-o"></i> 7</div>
						</div>
						<div class="blog-item-title">
							<h3><a href="#">Protect Your Child's Teeth event</a></h3>
						</div>
						<div class="blog-item-author"><a href="#">by Dr. Kaeden Bernard</a></div>
						<div class="blog-item-text">Facilitating the child care for the given oppurtunities</div>
						<!--<div class="blog-item-button"><a href=# class="btn btn-primary-1">READ MORE</a></div>-->
					</div>
					
					<!-- BLOG ITEM -->
					<div class="blog-item">
						<div class="blog-item-image"> <img src="images/a4.jpg" alt="" />
							<div class="blog-item-date"><i class="fa fa-calendar-o"></i> 03.10.2016</div>
							<div class="blog-item-comments"><i class="fa fa-comments-o"></i> 12</div>
						</div>
						<div class="blog-item-title">
							<h3><a href="#">smile please event!</a></h3>
						</div>
						<div class="blog-item-author"><a href="#">by Dr. Kaeden Bernard</a></div>
						<div class="blog-item-text">sharing the information about oral care throught the people of the bangalore.</div>
						<!--<div class="blog-item-button"><a href=# class="btn btn-primary-1">READ MORE</a></div>-->
					</div>
				</div>
				<!-- BLOG BUTTONS -->
