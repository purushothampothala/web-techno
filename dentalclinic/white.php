	...
	<div class="container">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Tooth whitening</li>
			</ol>
		</div>
	</div>
</div>
				...
				<div class="blog-item">
					...
					<div class="blog-item-desc single-desc">
						...
						<div class="blog-item-text">
							...
							<p>Our Dental Clinic is dedicated to providing the most up to date general, orthodontic and family dentistry. Our Clinic has grown to provide a world class facility for the treatment of tooth loss, dental cosmetics and advanced restorative dentistry.</p>
							<p class="selected">Restoration of the underlying natural tooth shade is possible by simply removing surface stains caused by extrinsic factors, stainers such as tea, coffee, red wine and tobacco. The buildup of calculus and tartar can also influence the staining of teeth. This restoration of the natural tooth shade is achieved by having the teeth cleaned by a dental professional (commonly termed "scaling and polishing"), or at home by various oral hygiene methods. Calculus and tartar are difficult to remove without a professional clean.</p>
							<p>To whiten the natural tooth shade, bleaching is suggested. It is a common procedure in cosmetic dentistry, and a number of different techniques are used by dental professionals. There is a plethora of products marketed for home use to do this also. Techniques include bleaching strips, bleaching pens, bleaching gels and laser tooth whitening. Bleaching methods generally use either hydrogen peroxide or carbamide peroxide which breaks down into hydrogen peroxide.</p>
					...
					<div class="blog-item-media">
						<div class="comment first-comm">
							...
							<div class="comment-body">
								...
								<div class="comment-body-text"> I've been a patent at a private practice for years having had company dental insurance, sadly that is no longer available so I had to find another surgery, this one was recommended and honestly I am super impressed, great staff, spotless facilities, modern equipment , everything I could wish for. </div>
							</div>
							<div class="comment">
						...
						<div class="comment">
							...
							<div class="comment-body">
								...
								<div class="comment-body-reply"> <a href="#reply" class="btn btn-primary-1 btn-sm"><i class="fa fa-reply"></i> REPLY</a> </div>
								<div class="comment-body-text">I've been a patent at a private practice for years having had company dental insurance, sadly that is no longer available so I had to find another surgery, this one was recommended and honestly I am super impressed, great staff, spotless facilities, modern equipment , everything I could wish for. 
							</div>
							</div>
						</div>
