	...
	<div class="container">
		<div class="row"> 
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="top-bar-social"> <a href="https://www.facebook.com/"><i class="fa fa-facebook"></i></a> <a href="#"><i class="fa fa-google-plus"></i></a> <a href="https://twitter.com/"><i class="fa fa-twitter"></i></a> <a href="https://www.skype.com/en/"><i class="fa fa-skype"></i></a> </div>
				<div class="top-bar-mail"> <i class="fa fa-envelope"></i> <a href="https://mchaitra96@gmail.com">office@dental.com</a> </div>
			</div>
		</div>
	</div>
</div><!-- =========================
	...
	<div class="container">
		<div class="row"> 
			...
			<div class="col-lg-4 col-md-4 col-sm-5 col-xs-12">
				<div class="header-logo"> <a href="index.php"><img src="images/dentalclinic.png" alt="" />
			...
			<div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
				...
				<div class="header-phone"> <i class="fa fa-phone"></i> +91 8132918672 </div>
			</div>
		</div>
	</div>
</div>
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="mobile-bar-cont">
					<div class="top-menu-logo"> <a href="index.php"><img src="images/dentalclinic.png" alt="" />
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown"><a  data-toggle="dropdown" href="#">ABOUT US</a>
						<ul class="dropdown-menu" role="menu">
							...
							<li><a href="about1.php">Why choose us? </a></li>
						</ul>
					</li>
					<li class="active" class="dropdown"> <a data-toggle="dropdown" href="services.php">SERVICES</a>
					...
					<li class="dropdown"> <a data-toggle="dropdown" href="#">AWARDS & MEDIA</a>
						<ul class="dropdown-menu" role="menu">
							<li><a href="awards.php">Awards</a></li>
							<li><a href="news.php">News & Events</a></li>
							<li><a href="gallery2.php">Media</a></li>
	...
	<div class="container">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">TMJ treatment</li>
			</ol>
		</div>
	</div>
</div>
	...
	<div class="container">
		<div class="row">
			<div class="blog-container col-lg-9 col-md-9 col-sm-9 col-xs-12">
				<div class="blog-item">
					<div class="blog-item-image"> <img src="images/p1.jpg" alt="" />
						<div class="blog-item-info">
							...
							<div class="blog-item-category"><i class="fa fa-folder-o"></i> Oral Exam</div>
						</div>
					</div>
					<div class="blog-item-desc single-desc">
						<div class="blog-item-title">
							<h3><a href="#">TMJ treatment</a></h3>
						</div>
						<div class="blog-item-author"><a href="#">by Dr. Kaeden Bernard</a></div>
						<div class="blog-item-text">
							<p>TMJ treatment (termed tooth bleaching when utilizing bleach), is either restoration of natural tooth shade or whitening beyond natural tooth shade, depending on the definition used.</p>
							...
							<!--<div class="quote">
								...
								<div class="quote-info">
									<span class="quote-name">Jeanette Evvie,</span>
									<span class="quote-position">Student</span>
								</div>
							</div>-->
							<!--<h3>Experience H3</h3>
							...
							<div class="image-carousel">
								<div class="owl-image-carousel" id="owl-image-carousel">
									<div class="image-carousel-item"> <img src="images/p2.jpg" alt="" />
									...
									<div class="image-carousel-item"> <img src="images/p3.jpg" alt="" />
										<div class="image-carousel-item-info">
											<h4 class="image-carousel-item-title">Title image or gallery</h4>
											<p class="image-carousel-item-desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt labore.</p>
										</div>
									</div>
									<div class="image-carousel-item"> <img src="images/p4.jpg" alt="" />
										<div class="image-carousel-item-info">
											<h4 class="image-carousel-item-title">Title image or gallery</h4>
											<p class="image-carousel-item-desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt labore.</p>
										</div>
							...
							<p>Our Dental Clinic is dedicated to providing the most up to date general, orthodontic and family dentistry. Our Clinic has grown to provide a world class facility for the treatment of tooth loss, dental cosmetics and advanced restorative dentistry.</p>
							<p class="selected">The temporomandibular joints (TMJ) are the two joints connecting the jawbone to the skull. It is a bilateral synovial articulation between the temporal bone of the skull above and the mandible below; it is from these bones that its name is derived. This joint is unique in that it is a bilateral joint that functions as one unit. Since the TMJ is connected to the mandible, the right and left joints must function together and therefore are not independent of each other.</p>
							<p>The capsule is a dense fibrous membrane that surrounds the joint and incorporates the articular eminence. It attaches to the articular eminence, the articular disc and the neck of the mandibular condyle.</p>
							<div class="blog-item-text-image left col-lg-5 col-md-5 col-sm-5 col-xs-12"> <img src="images/p5.jpg" alt="" />
					...
					<!--<div class="blog-item-poster">
						<div class="blog-item-poster-image"> <img src="images/p6.jpg" alt="" /> </div>
					...
					<div class="blog-item-media">
						<div class="comment first-comm">
							<div class="comment-avatar"> <img src="images/k1.jpg" alt="" /> </div>
							<div class="comment-body">
								<div class="comment-body-info">
									<span class="comment-body-info-name">Emma Harmon,</span>
									<span class="comment-body-info-position">Dental Care Patient</span>
									<br>
									<span class="comment-body-info-date">Posted on April 15, 2016</span>
								</div>
								<div class="comment-body-reply"> <a href="#reply" class="btn btn-primary-1 btn-sm"><i class="fa fa-reply"></i> REPLY</a> </div>
								<div class="comment-body-text"> Very friendly and efficient practice who email reminders for check ups which in this busy world is helpful. Very high standard of dentistry which is usually found in expensive private practices. Highly recommended.</div>
							</div>
							<div class="comment">
								<div class="comment-avatar"> <img src="images/k2.jpg" alt="" /> </div>
								<div class="comment-body">
									<div class="comment-body-info">
										<span class="comment-body-info-name">Bryan White,</span>
										<span class="comment-body-info-position">Hygienist</span>
										<br>
										<span class="comment-body-info-date">Posted on April 15, 2016</span>
									</div>
									<div class="comment-body-reply"> <a href="#reply" class="btn btn-primary-1 btn-sm"><i class="fa fa-reply"></i> REPLY</a> </div>
						...
						<div class="comment">
							<div class="comment-avatar"> <img src="images/k3.jpg" alt="" /> </div>
							<div class="comment-body">
								<div class="comment-body-info">
									<span class="comment-body-info-name">Tamela Arleen,</span>
									<span class="comment-body-info-position">Dental Care Patient</span>
									<br>
									<span class="comment-body-info-date">Posted on April 15, 2016</span>
								</div>
					...
					<div class="comment">
						...
						<?php
                                 include "connect.php";
                                $stmt = $conn->prepare("SELECT * FROM reply");
                                    $stmt->execute();              
                                    $res = $stmt->rowcount();
                                        if ($res){
						...
						<div class="comment">
							...
							<div class="comment-body">
								<div class="comment-body-info">
									<span class="comment-body-info-name"><?= $data->name ?></span>
									<span class="comment-body-info-position">Dental Care Patient</span>
									<br>
									<span class="comment-body-info-date">Posted on April 15, 2016</span>
								</div>
								<div class="comment-body-reply"> <a href="#reply" class="btn btn-primary-1 btn-sm"><i class="fa fa-reply"></i> REPLY</a> </div>
								<div class="comment-body-text"> <?= $data->message ?> </div>
							</div>
						</div>
						            <?php
                                          }
					...
					<div class="blog-item-commform" id="reply">
						<h3>LEAVE A REPLY</h3>
						<form>
							<div class="row">
							...
							<div class="row latest-row">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 booking-form-item">
									...
									<span>Your email address will not be published.<br>
				...
				<div class="related-items">
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="blog-item">
								<div class="blog-item-image"> <img src="images/p7.jpg" alt="" />
									<div class="related-item-overlay">
										...
										<div class="related-item-button"> <a href="white.php" class="btn btn-primary-1 btn-sm">READ MORE</a> </div>
									</div>
								</div>
								<div class="blog-item-info">
									<div class="blog-item-date"><i class="fa fa-calendar-o"></i> 03.10.2016</div>
									<div class="blog-item-comments"><i class="fa fa-comments-o"></i> 12</div>
									<div class="blog-item-view"><i class="fa fa-eye"></i> 140</div>
									<div class="blog-item-category"><i class="fa fa-folder-o"></i> Tooth whitening</div>
								</div>
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="blog-item">
								<div class="blog-item-image"> <img src="images/d10.jpg" alt="" />
									<div class="related-item-overlay">
										<div class="related-item-title"> <a href="#">
											<h3>Tooth cleaning</h3>
											</a> </div>
										<div class="related-item-author"> <a href="#">by Dr. Kaeden Bernard</a> </div>
										<div class="related-item-button"> <a href="clean.php" class="btn btn-primary-1 btn-sm">READ MORE</a> </div>
									</div>
								</div>
								<div class="blog-item-info">
									<div class="blog-item-date"><i class="fa fa-calendar-o"></i> 03.10.2016</div>
									<div class="blog-item-comments"><i class="fa fa-comments-o"></i> 12</div>
									<div class="blog-item-view"><i class="fa fa-eye"></i> 140</div>
									<div class="blog-item-category"><i class="fa fa-folder-o"></i> Tooth cleaning</div>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="right-bar col-lg-3 col-md-3 col-sm-3 col-xs-12">
				...
				<div class="right-bar-categories">
					...
					<ul>
						<li><a href="oralexam.php">Oral exams</a></li>
						<li><a href="white.php">Teeth whitening</a></li>
						<li><a href="clean.php">Teeth cleaning</a></li>
						<li><a href="x.php">X-rays</a></li>
						<li><a href="crown.php">Crowns</a></li>
						<li><a href="fill.php">Fillings and bridges</a></li>
						<li><a href="implant.php">Implants</a></li>
						<li><a href="extract.php">Extractions</a></li>
						<li><a href="canal.php">Root canals</a></li>
						<li><a href="surgery.php">Surgical implant placements</a></li>
					</ul>
				</div>
				<div class="right-bar-archive">
					...
					<ul>
						<li><a href="#">February 2016
							<span class="right-bar-archive-tag">43</span>
							</a></li>
						<li><a href="#">Janyary 2016
							<span class="right-bar-archive-tag">64</span>
							</a></li>
						<li><a href="#">December 2015
							<span class="right-bar-archive-tag">23</span>
							</a></li>
						<li><a href="#">November 2015
							<span class="right-bar-archive-tag">66</span>
							</a></li>
						<li><a href="#">October 2016
							<span class="right-bar-archive-tag">13</span>
							</a></li>
					</ul>
				</div>
				...
				<div class="right-bar-tags">
					...
					<a href="clean.php" class="right-bar-tags-item">Dental</a> <a href="doctor.php" class="right-bar-tags-item">Doctor</a> <!--<a href="#" class="right-bar-tags-item">Health</a>--> <a href="white.php" class="right-bar-tags-item">Tooth whitening</a> <a href="clean.php" class="right-bar-tags-item">Cleaning</a> <a href="extract.php" class="right-bar-tags-item">Tooth</a> <a href="oralexam.php" class="right-bar-tags-item">Oral exams</a> <a href="fill.php" class="right-bar-tags-item">Fillings and bridges</a> </div>
			</div>
		</div>
	</div>
</div>
...
<!--<div class="container">
	<center><h3><u>ORAL EXAM</u></h3></center>
       <P><h6><u>Examination</u></h6>
<b>Intra oral </b></P>

<p>Examination using intra oral cameras to view the nooks and corners of the mouth under magnification to view what the naked eye cannot see.</p>

<P><h5><u>xrays</u></h5>
<b>Digital OPG</b></P>

<p>Full mouth xray in one shot - can show the bone structure, bone mineral density, and the diseases within the teeth, jaws. It also visualises the sinuses, nose, joints, salivary glands</p>

<b>Digital Lateral Cephalogram</b>

<p>Side view of the skull to measure the angulation of the upper jaw and lower jaw bones and teeth in order to plan diagnose any disturbances form the normal</p>

<b>RVG</b>
<p>
Digital xray of the tooth that can be viewed on the computer screen, shared and stored in kilobites and not on perishable films.</p>
<hr>
<u>CT scan</u>
<p>
<b>Cone Beam CT</b>
<p>
Less radiation CT of the skull. The machine is incorporated inteh simple full mout xray (OPG) machine - so the patient does not have to be subjected to the claustrophobic experience of the normal CT procedure. It is taken in minutes and the patietn just needs to stand/ sit - so it gives the perfect view of the soft tissues . It helps the patient and the doctor visualise the jaw bones and the teeth 3 dimensionally. More accurate and detailed than a CT scan . The treatment for procedures like IMPLANTS can be virtually planned and executed meticulously without human error.</p>
<u>Others</u>
<p>
<b>Sialoendoscopy</b></p>
<p>
The visualisation of the insides of the salivary gland through a very very thin fiber optic device. It can disgnose any blockages in the salivary gland (available in select centres only)</p>

<b>LASERS</b>
<p>
The Amplified light can be used to diagnose what naked eyes cannot see. To diagnosed cracked tooth, decay etc.</p>
		...
		<div class="row">
			<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 footer-matchheight">
				<div class="row"> 
					...
					<!-- FOOTER ITEM 1 -->
					<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 footer-item footer-item-3 footer-matchheight" id="footer-item-3">
				<h3 class="footer-title"><i class="fa fa-map-marker"></i> CONTACTS</h3>
				<div class="footer-item-3-phone"> <i class="fa fa-phone"></i> +91 8132918672 </div>
				<div class="footer-item-3-location"> <i class="flaticon-navigation-arrow"></i> 2nd Floor, 3rd Cross Rd, Stage I, Kengeri Satellite Town,, Stage I, Kengeri Satellite Town, Bengaluru, Karnataka 560060 </div>
				<div class="footer-item-3-mail"> <i class="fa fa-envelope"></i> <a href="https://mchaitra96@gmail.com">office@dental.com</a> </div>
				<div class="footer-item-3-socials"> <a href="https://www.facebook.com/"><i class="fa fa-facebook"></i></a> <a href="#"><i class="fa fa-google-plus"></i></a> <a href="https://www.twitter.com/"><i class="fa fa-twitter"></i></a> <a href="https://www.skype.com/en/"><i class="fa fa-skype"></i></a> </div>
			</div> 
					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 footer-item footer-item-1">
						...
						<div class="tweet">
							<div class="tweet-login"> <a href="https://www.twitter.com/">@DentalClinic</a> </div>
							<div class="tweet-text"> Easy tip to the daily routine. </div>
							<div class="tweet-date"> 03.10.2016 </div>
						</div>
						<div class="tweet">
							<div class="tweet-login"> <a href="https://www.twitter.com/">@DentalClinic</a> </div>
							<div class="tweet-text"> Exatraction can not be necessary </div>
							<div class="tweet-date"> 03.10.2016 </div>
						</div>
						<div class="tweet">
							<div class="tweet-login"> <a href="https://www.twitter.com/">@DentalClinic</a> </div>
							<div class="tweet-text"> Proper implanation gives more flexible. </div>
							<div class="tweet-date"> 03.10.2016 </div>
						</div>
					</div>
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 footer-copyright">
						<div> Copyright &copy; 2016 <a href="https://themeforest.net/item/dentalclinic-responsive-clinic-php-template/17390217" target="_blank">DentalClinic</a> Template by <a href="http://fvdthemes.com/" target="_blank">FVD Themes</a> </div>
					</div>
				</div>
			</div>
		...
		<form class="" action="doc.php"  method="post">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 booking-form-item f-doctor">
					<select id="form-doctor" class="form-doctor" name="doctor">
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 booking-form-item date">
					<input type="text" class="datepicker-f" id="datepicker1" name="ddate" data-validation="required" placeholder="Date" />
					<div class="help help-sm help-red">!</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 booking-form-item time-f">
					<input type="text" class="timepicker-f" id="timepicker1" name="ttime" data-validation="required" placeholder="Time" />
					<div class="help help-sm help-red">!</div>
				</div>
			</div>
			<div class="row">
