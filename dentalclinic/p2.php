...
<div class="preloader" id="preloader"> <img src="images/" alt="" /> </div>
<!-- =========================
     TOP BAR
============================== -->
	...
	<div class="container">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Tooth cleaning</li>
			</ol>
		</div>
	</div>
</div>
				...
				<div class="blog-item">
					...
					<div class="blog-item-desc single-desc">
						<div class="blog-item-title">
							<h3><a href="#">Tooth cleaning</a></h3>
						</div>
						<div class="blog-item-author"><a href="#">by Dr. Kaeden Bernard</a></div>
						<div class="blog-item-text">
							<p>Tooth cleaning (termed tooth bleaching when utilizing bleach), is either restoration of natural tooth shade or whitening beyond natural tooth shade, depending on the definition used.</p>
							...
							<div class="image-carousel">
								<div class="owl-image-carousel" id="owl-image-carousel">
									...
									<div class="image-carousel-item"> <img src="images/p4.jpg" alt="" />
										<div class="image-carousel-item-info">
											<h4 class="image-carousel-item-title"> Gallery</h4>
											<p class="image-carousel-item-desc">Images of the treatment provided.</p>
										</div>
									</div>
								</div>
							...
							<p>Our Dental Clinic is dedicated to providing the most up to date general, orthodontic and family dentistry. Our Clinic has grown to provide a world class facility for the treatment of tooth loss, dental cosmetics and advanced restorative dentistry.</p>
							<p class="selected">If you wear a retainer, you might be wondering how to care for it. Your retainer sits inside your mouth and against your teeth, so it quickly accumulates bacteria, plaque, and tartar. Just like you brush your teeth every day, it’s important to clean your retainer every day.</p>
							<p>Many people need to wear a retainer full time for a while after they have their braces removed. This is because teeth aren’t set in a rigid environment. Even after they’ve been corrected by braces and moved into a better position, they can shift over time.</p>
							<div class="blog-item-text-image left col-lg-5 col-md-5 col-sm-5 col-xs-12"> <img src="images/p5.jpg" alt="" />
								<div class="blog-item-text-image-info">
									<h4 class="blog-item-text-image-title">Examine of the treatment</h4>
									<p class="blog-item-text-image-desc">Each of the picture is the present images of the hospital.</p>
								</div>
							</div>
							
							<p>Hawley retainers are molded out of acrylic to fit your mouth. They have a wire that helps hold the retainer in place. This type of retainer is removable, so it’s easy to clean.</p>
							<p>Clear plastic retainers may go by the names Essix, Vivera, or clear aligners. These retainers slip over your teeth and are pretty much invisible. They’re easy to remove, but aren’t as durable as Hawley retainers.</p>
					...
					<div class="blog-item-media">
						<div class="comment first-comm">
							...
							<div class="comment-body">
								...
								<div class="comment-body-text"> Just as I wanted, a quick and easy check up with teeth cleaning. The staff are all really friendly and they made the process very easy </div>
							</div>
							<div class="comment">
