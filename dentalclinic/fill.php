	...
	<div class="container">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Tooth filling</li>
			</ol>
		</div>
	</div>
</div>
				...
				<div class="blog-item">
					...
					<div class="blog-item-desc single-desc">
						<div class="blog-item-title">
							<h3><a href="#">Tooth filling</a></h3>
						</div>
						<div class="blog-item-author"><a href="#">by Dr. Kaeden Bernard</a></div>
						<div class="blog-item-text">
							<p>Tooth filling (termed tooth bleaching when utilizing bleach), is either restoration of natural tooth shade or whitening beyond natural tooth shade, depending on the definition used.</p>
							...
							<p>Our Dental Clinic is dedicated to providing the most up to date general, orthodontic and family dentistry. Our Clinic has grown to provide a world class facility for the treatment of tooth loss, dental cosmetics and advanced restorative dentistry.</p>
							<p class="selected">A filling is a way to restore a tooth damaged by decay back to its normal function and shape. When a dentist gives you a filling, he or she first removes the decayed tooth material, cleans the affected area, and then fills the cleaned out cavity with a filling material.</p>
							...
							<p>Gold fillings are made to order in a laboratory and then cemented into place. Gold inlays are well tolerated by gum tissues, and may last more than 20 years. For these reasons, many authorities consider gold the best filling material. However, it is often the most expensive choice and requires multiple visits.</p>
							<p>Amalgam (silver) fillings are resistant to wear and relatively inexpensive. However, due to their dark color, they are more noticeable than porcelain or composite restorations and are not usually used in very visible areas, such as front teeth.</p>
							<p>Composite (plastic) resins are matched to be the same color as your teeth and therefore used where a natural appearance is desired. The ingredients are mixed and placed directly into the cavity, where they harden. Composites may not be the ideal material for large fillings as they may chip or wear over time. They can also become stained from coffee, tea or tobacco, and do not last as long as other types of fillings generally from three to 10 years.</p>
					...
					<div class="blog-item-media">
						<div class="comment first-comm">
							...
							<div class="comment-body">
								...
								<div class="comment-body-text"> This surgery is fantastic. I have been coming over 15 years and I got an appointment fairly quickly and considering I needed a follow up I got that within 1 week which I think is fantastic. </div>
							</div>
							<div class="comment">
