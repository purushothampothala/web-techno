		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<ul class="nav navbar-nav">
					...
					<li class="active" class="dropdown"> <a data-toggle="dropdown" href="#">SERVICES</a>
				...
				<div class="blog-item">
					...
					<div class="blog-item-desc single-desc">
						...
						<div class="blog-item-text">
							<p>Surgery (termed tooth bleaching when utilizing bleach), is either restoration of natural tooth shade or whitening beyond natural tooth shade, depending on the definition used.</p>
							...
							<p>Our Dental Clinic is dedicated to providing the most up to date general, orthodontic and family dentistry. Our Clinic has grown to provide a world class facility for the treatment of tooth loss, dental cosmetics and advanced restorative dentistry.</p>
							<p class="selected">Orthognathic surgery is surgery performed on the bones of the jaws to change their positions. Orthognathic surgery is corrective facial surgery where deformities of the jaw exist. It may be indicated for functional, cosmetic, or health reasons. It is surgery commonly done on the jaws in conjunction with orthodontic treatment, which straightens the teeth.</p>
							<p>Facial trauma, also known as maxillofacial trauma, is any injury to the face or jaw bone. Facial trauma may present with skin lacerations, obstruction to the nasal cavity or sinuses, damage to the orbital sockets, fracture to the jawbone and missing teeth.</p>
