		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<ul class="nav navbar-nav">
					...
					<li class="active"> <a  href="blog4.php">BLOG</a>
						<!--<ul class="dropdown-menu" role="menu">
		...
		<div class="row">
			<div class="blog-container col-lg-9 col-md-9 col-sm-9 col-xs-12">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="blog-item">
							<div class="blog-item-image"> <img src="images/b1.jpg" alt="" />
								<div class="blog-item-info">
									...
									<div class="blog-item-category"><i class="fa fa-folder-o"></i> Teeth whitening</div>
								</div>
							</div>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="blog-item">
							<div class="blog-item-image"> <img src="images/b2.jpg" alt="" />
								<div class="blog-item-info">
									<div class="blog-item-date"><i class="fa fa-calendar-o"></i> 03.10.2016</div>
									<div class="blog-item-comments"><i class="fa fa-comments-o"></i> 12</div>
									<div class="blog-item-view"><i class="fa fa-eye"></i> 140</div>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="blog-item">
							<div class="blog-item-image"> <img src="images/b3.jpg" alt="" />
								<div class="blog-item-info">
									<div class="blog-item-date"><i class="fa fa-calendar-o"></i> 03.10.2016</div>
									<div class="blog-item-comments"><i class="fa fa-comments-o"></i> 12</div>
									<div class="blog-item-view"><i class="fa fa-eye"></i> 140</div>
							...
							<div class="blog-item-desc">
								...
								<div class="blog-item-author"><a href="#">by Dr. Kaeden Bernard</a></div>
								<div class="blog-item-text">
									<p>Oral exam (termed tooth bleaching when utilizing bleach), is either restoration of natural tooth shade or whitening beyond natural tooth shade, depending on the definition used.</p>
									<p>Restoration of the underlying, natural tooth shade is possible by simply removing surface (extrinsic) stains (e.g. from tea, coffee, red wine and tobacco) and calculus (tartar). This is achieved by having the teeth cleaned by a dental professional (commonly termed "scale and polish".</p>
								</div>
								<!--<div class="blog-item-button"><a href=# class="btn btn-primary-1">READ MORE</a></div>-->
							</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 mission-video">
				<iframe width="457" height="314" src="https://www.youtube.com/embed/A7FYMRExufg" allowfullscreen></iframe>
			</div>
			<hr>
		</div>
	</div>
...
<div class="mission">
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 mission-video">
				<iframe width="457" height="314" src="https://www.youtube.com/embed/jLBUEKccyrA" allowfullscreen></iframe>
			</div>
