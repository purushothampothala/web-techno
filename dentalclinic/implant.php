				...
				<div class="blog-item">
					<div class="blog-item-image"> <img src="images/p1.jpg" alt="" />
						<div class="blog-item-info">
							...
							<div class="blog-item-category"><i class="fa fa-folder-o"></i> Implants</div>
						</div>
					</div>
					<div class="blog-item-desc single-desc">
						<div class="blog-item-title">
							<h3><a href="#">Implants</a></h3>
						</div>
						...
						<div class="blog-item-text">
							...
							<p>The risks and complications related to implant therapy divide into those that occur during surgery (such as excessive bleeding or nerve injury), those that occur in the first six months (such as infection and failure to osseointegrate) and those that occur long-term (such as peri-implantitis and mechanical failures). In the presence of healthy tissues, a well-integrated implant with appropriate biomechanical loads can have 5-year plus survival rates from 93 to 98 percent[1][2][3] and 10 to 15 year lifespans for the prosthetic teeth.[4] Long-term studies show a 16- to 20-year success (implants surviving without complications or revisions) between 52% and 76%, with complications occurring up to 48% of the time.</p>
					...
					<div class="blog-item-media">
						<div class="comment first-comm">
							...
							<div class="comment-body">
								...
								<div class="comment-body-text"> The staff are friendly and warm the receptionist knows me when I walk in with my family. My Dentist is friendly and professional. </div>
							</div>
							<div class="comment">
