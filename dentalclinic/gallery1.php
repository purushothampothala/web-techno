...
<!-- =========================
      FAV AND TOUCH ICONS  
============================== -->
<link rel="shortcut icon" href="images/denatclinic.png">
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown"> <a data-toggle="dropdown" href="sevices.html">SERVICES</a>
					...
					<li class="dropdown" class="active"> <a data-toggle="dropdown" href="#">AWARDS & MEDIA</a>
						<ul class="dropdown-menu" role="menu">
...
<div class="gallery gallery-1">
	<div class="container">
		<div class="row">
			<div class="gallery-text"> Our Dental Clinic is dedicated to providing the most up to date general, orthodontic and family dentistry. Our Clinic has grown to provide a world class facility for the treatment of tooth loss, dental cosmetics and advanced restorative dentistry.</div>
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<ul id="isotope-filter">
					<li><a class="active" data-filter="*">Gallery</a></li>
					<li><a data-filter=".success">Success stories</a></li>
					<li><a data-filter=".cat1">Treatments</a></li>
					<li><a data-filter=".cat2">Correction</a></li>
				</ul>
			</div>
			<div class="gallery-1-items" id="isotope-items">
				<div class="gallery-1-item isotope-item col-lg-4 col-md-4 col-sm-4 col-xs-12 success">
					<div class="gallery-1-item-image"> <img src="images/g1.jpg" alt="" /> <a href="images/g1.jpg" class="fancybox">
						<div class="gallery-1-item-overlay"> <i class="fa fa-plus"></i> </div>
						</a> </div>
					<div class="gallery-1-item-info">
						<h4 class="gallery-1-item-title">Child care</h4>
						<p class="gallery-1-item-desc"></p>
					</div>
				</div>
				<div class="gallery-1-item isotope-item col-lg-4 col-md-4 col-sm-4 col-xs-12 cat1">
					<div class="gallery-1-item-image"> <img src="images/g2.jpg" alt="" /> <a href="images/g2.jpg" class="fancybox">
						<div class="gallery-1-item-overlay"> <i class="fa fa-plus"></i> </div>
						</a> </div>
					<div class="gallery-1-item-info">
						<h4 class="gallery-1-item-title">Oral exams</h4>
						<p class="gallery-1-item-desc"></p>
					</div>
				</div>
				<div class="gallery-1-item isotope-item col-lg-4 col-md-4 col-sm-4 col-xs-12 success">
					<div class="gallery-1-item-image"> <img src="images/g3.jpg" alt="" /> <a href="images/g3.jpg" class="fancybox">
						<div class="gallery-1-item-overlay"> <i class="fa fa-plus"></i> </div>
						</a> </div>
					<div class="gallery-1-item-info">
						<h4 class="gallery-1-item-title">Tooth extraction</h4>
						<p class="gallery-1-item-desc"></p>
					</div>
				</div>
				<div class="gallery-1-item isotope-item col-lg-4 col-md-4 col-sm-4 col-xs-12 cat2">
					<div class="gallery-1-item-image"> <img src="images/g4.jpg" alt="" /> <a href="images/g4.jpg" class="fancybox">
						<div class="gallery-1-item-overlay"> <i class="fa fa-plus"></i> </div>
						</a> </div>
					<div class="gallery-1-item-info">
						<h4 class="gallery-1-item-title">Tooth correction</h4>
						<p class="gallery-1-item-desc"></p>
					</div>
				</div>
				<div class="gallery-1-item isotope-item col-lg-4 col-md-4 col-sm-4 col-xs-12 cat2">
					<div class="gallery-1-item-image"> <img src="images/g5.jpg" alt="" /> <a href="images/g5.jpg" class="fancybox">
						<div class="gallery-1-item-overlay"> <i class="fa fa-plus"></i> </div>
						</a> </div>
					<div class="gallery-1-item-info">
						<h4 class="gallery-1-item-title">Dental surgery</h4>
						<p class="gallery-1-item-desc"></p>
					</div>
				</div>
				<div class="gallery-1-item isotope-item col-lg-4 col-md-4 col-sm-4 col-xs-12 cat1">
					<div class="gallery-1-item-image"> <img src="images/g6.jpg" alt="" /> <a href="images/g6.jpg" class="fancybox">
						<div class="gallery-1-item-overlay"> <i class="fa fa-plus"></i> </div>
						</a> </div>
					<div class="gallery-1-item-info">
						<h4 class="gallery-1-item-title">Tooth extraction</h4>
