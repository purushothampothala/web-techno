		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown"> <a data-toggle="dropdown" href="services">SERVICES</a>
		...
		<div class="row">
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="doctor-info">
					<div class="doctor-info-image"> <img src="images/m1.jpg" alt="" /> </div>
					<div class="doctor-info-name"> Arnie Alban </div>
					<div class="doctor-info-position"> Pedodontics </div>
					<div class="doctor-info-socials"> <a href=""><i class="fa fa-facebook"></i></a> <a href=""><i class="fa fa-twitter"></i></a> <a href="https://www.skype.com/"><i class="fa fa-skype"></i></a> </div>
				...
				<div class="doctor-text">
					...
					<div class="doctor-text-booking">
						...
						<form class="" action="doc.php"  method="post">
							...
							<div>
								<input type="hidden" name="doctor" value="ARNIE ALBAN">
							</div>
			...
			<div class="doctors-container">
				<div class="doctors-item col-lg-3 col-md-3 col-sm-3 col-xs-12">
					<div class="doctors-item-container">
						<div class="doctors-item-image"> <img src="images/m3.jpg" alt="" /> </div>
						<div class="doctors-item-name">Wyatt Esmond</div>
						<div class="doctors-item-position">General Dentist</div>
					</div>
					<div class="doctors-item-social"> <a href=""><i class="fa fa-facebook"></i></a> <a href=""><i class="fa fa-twitter"></i></a> <a href="https://www.skype.com/"><i class="fa fa-skype"></i></a> </div>
				...
				<div class="doctors-item col-lg-3 col-md-3 col-sm-3 col-xs-12">
					<div class="doctors-item-container">
						<div class="doctors-item-image"> <img src="images/m2.jpg" alt="" /> </div>
				...
				<div class="doctors-item col-lg-3 col-md-3 col-sm-3 col-xs-12">
					<div class="doctors-item-container">
						<div class="doctors-item-image"> <img src="images/m4.jpg" alt="" /> </div>
				...
				<div class="doctors-item col-lg-3 col-md-3 col-sm-3 col-xs-12">
					<div class="doctors-item-container">
						<div class="doctors-item-image"> <img src="images/m6.jpg" alt="" /> </div>
...
<div class="bookform bookform-1" id="bookform1">
	<div class="bookform-left">
		...
		<form class="" action="doc.php"  method="post">
			...
			<div>
              	<input type="hidden" name="doctor" value="Leslie Dustin">
              </div>
...
<div class="bookform" id="bookform2">
	<div class="bookform-left">
		...
		<form class="bookform-form" action="doc.php"  method="post">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 booking-form-item name">
			...
			<div>
              	<input type="hidden" name="doctor" value="Wyatt Esmond">
              </div>
			<div class="form-messages form-messages-modal"></div>
		</form>
	</div>
	<div class="bookform-right">
		<div class="doctor-info">
			<div class="doctor-info-image"> <img src="images/m3.jpg" alt="" /> </div>
...
<div class="bookform" id="bookform3">
	...
	<div class="bookform-right">
		<div class="doctor-info">
			<div class="doctor-info-image"> <img src="images/m2.jpg" alt="" /> </div>
			<div class="doctor-info-name"> Arnie Alban </div>
			<div class="doctor-info-position"> Pedodontics </div>
			<div class="doctor-info-hours-title"> OPENING HOURS </div>
			<div class="doctor-info-hours">
...
<div class="bookform" id="bookform4">
	<div class="bookform-left">
		...
		<form class="" action="doc.php" method="post">
			...
			<div>
				<input type="hidden" name="doctor" value="Dustin Callahan">
			</div>
			<div class="form-messages form-messages-modal"></div>
		</form>
	</div>
	<div class="bookform-right">
		<div class="doctor-info">
			<div class="doctor-info-image"> <img src="images/m4.jpg" alt="" /> </div>
...
<div class="bookform" id="bookform5">
	<div class="bookform-left">
		...
		<form class="bookform-form" action="doc.php"  method="post">
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 booking-form-item date">
					<input type="text" class="datepicker-f" id="datepicker5" name="ddate" data-validation="required" placeholder="Date" />
					<div class="help help-sm help-red">!</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 booking-form-item time-f">
					<input type="text" class="timepicker-f" id="timepicker5" name="ttime" data-validation="required" placeholder="Time" />
					<div class="help help-sm help-red">!</div>
				</div>
			</div>
			<div class="row">
			...
			<div>
				<input type="hidden" name="doctor" value="Kristin Weaver">
			</div>
			<div class="form-messages form-messages-modal"></div>
		</form>
	</div>
	<div class="bookform-right">
		<div class="doctor-info">
			<div class="doctor-info-image"> <img src="images/m6.jpg" alt="" /> </div>
...
<div class="bookform" id="bookform6">
	<div class="bookform-left">
		...
		<form class="" action="doc.php"  method="post">
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 booking-form-item date">
					<input type="text" class="datepicker-f" id="datepicker6" name="ddate" data-validation="required" placeholder="Date" />
					<div class="help help-sm help-red">!</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 booking-form-item time-f">
					<input type="text" class="timepicker-f" id="timepicker6" name="ttime" data-validation="required" placeholder="Time" />
					<div class="help help-sm help-red">!</div>
				</div>
			</div>
			<div class="row">
			...
			<div>
				<input type="hidden" name="doctor" value="Leslie Adams">
			</div>
			<div class="form-messages form-messages-modal"></div>
		</form>
	</div>
