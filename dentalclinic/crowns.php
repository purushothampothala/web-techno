		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<ul class="nav navbar-nav">
					...
					<li class="active" class="dropdown"> <a data-toggle="dropdown" href="sevices.php">SERVICES</a>
	...
	<div class="container">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Tooth crowns</li>
			</ol>
		</div>
	</div>
</div>
				...
				<div class="blog-item">
					<div class="blog-item-image"> <img src="images/p1.jpg" alt="" />
						<div class="blog-item-info">
							...
							<div class="blog-item-category"><i class="fa fa-folder-o"></i> Tooth crowns</div>
						</div>
					</div>
					<div class="blog-item-desc single-desc">
						<div class="blog-item-title">
							<h3><a href="#">Tooth crowns</a></h3>
						</div>
						<div class="blog-item-author"><a href="#">by Dr. Kaeden Bernard</a></div>
						<div class="blog-item-text">
							<p>Tooth crowns(termed tooth bleaching when utilizing bleach), is either restoration of natural tooth shade or whitening beyond natural tooth shade, depending on the definition used.</p>
							...
							<div class="blog-item">
								<div class="blog-item-image"> <img src="images/p7.jpg" alt="" />
									<div class="related-item-overlay">
										...
										<div class="related-item-button"> <a href="white.html" class="btn btn-primary-1 btn-sm">READ MORE</a> </div>
									</div>
								</div>
								<div class="blog-item-info">
									<div class="blog-item-date"><i class="fa fa-calendar-o"></i> 03.10.2016</div>
