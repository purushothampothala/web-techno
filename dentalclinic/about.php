		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<ul class="nav navbar-nav">
					...
					<li class="active" class="dropdown"><a data-toggle="dropdown" href="#">ABOUT US</a>
	...
	<div class="container">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Our profile</li>
			</ol>
		</div>
	</div>
</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 history-images">
				<div class="image-carousel">
					<div class="owl-image-carousel" id="owl-image-carousel">
						<div class="image-carousel-item"> <img src="images/h1.jpg" alt="" /> </div>
						<div class="image-carousel-item"> <img src="images/h2.jpg" alt="" /> </div>
						<div class="image-carousel-item"> <img src="images/d8.jpg" alt="" /> </div>
						<div class="image-carousel-item"> <img src="images/d9.jpg" alt="" /> </div>
					</div>
			...
			<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 history-text">
				...
				<p>Alliance Dental Care the joint venture between the India's leading healthcare groups, Apollo Hospitals & Trivitron Healthcare, envisions a complete makeover of Indian dental healthcare & aims to take dentistry to a world class level.</p>

                       <p> With a mission to bring affordable and world class medical services to India, Alliance introduces Apollo WHITE - a first of its kind dental care brand which is all set to create a unique success story with a fleet of 7 star dental spas, studios, clinics and express centers spread across the country; offering everything from Premium services, Avant Grade Cosmetic Dentistry to simple and affordable Dental services.</p>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 mission-text">
				<h3>OUR MISSION</h3>
				<p>Our mission is to offer to our patients the finest dental care in mid Missouri and provide exceptional, prompt customer service. We will work together with our patients to improve oral health, speech, chewing ability, and cosmetic appearance to enhance nutrition, confidence, and quality of life. We will rely on proven diagnostic technology, effective treatment protocols, and high-quality dental materials that will allow our patients to enjoy safe, long-lasting, and incredibly comfortable dental care.  
 
                  We will build relationships with our patients on honesty, trust, and comfort; and our emphasis will be placed on educating our patients so they are empowered to make knowledgeable decisions concerning their oral health and treatment options. Above all, we will honor others before ourselves.</p>
				<ul class="text-list">
			...
			<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 mission-video">
				<iframe width="457" height="314" src="https://www.youtube.com/embed/INO1eAeZJ9E" allowfullscreen></iframe>
			</div>
		</div>
	</div>
</div>
