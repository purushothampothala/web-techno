		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<ul class="nav navbar-nav">
					...
					<li class="active" class="dropdown"> <a data-toggle="dropdown" href="serives.php">SERVICES</a>
				...
				<div class="blog-item">
					...
					<div class="blog-item-desc single-desc">
						<div class="blog-item-title">
							<h3><a href="#">Tooth Extraction</a></h3>
						</div>
						<div class="blog-item-author"><a href="#">by Dr. Kaeden Bernard</a></div>
						<div class="blog-item-text">
							<p>Tooth extraction (termed tooth bleaching when utilizing bleach), is either restoration of natural tooth shade or whitening beyond natural tooth shade, depending on the definition used.</p>
							<p>Restoration of the underlying, natural tooth shade is possible by simply removing surf++ace (extrinsic) stains (e.g. from tea, coffee, red wine and tobacco) and calculus (tartar). This is achieved by having the teeth cleaned by a dental professional (commonly termed "scale and polish".</p>
							<!--<div class="quote">
							...
							<p>The branch of dentistry that deals primarily with extractions is oral surgery ("exodontistry"), although general dentists and periodontists often carry out tooth extraction routinely since it is a core skill taught in dental schools. Periodontists are performing more and more extractions, since they often follow up and place a dental implant.</p>
					...
					<div class="blog-item-media">
						<div class="comment first-comm">
							...
							<div class="comment-body">
								...
								<div class="comment-body-text"> I'm one of those people who is normally not a fan of going to the dentist, but this clinic makes a difference by making you feel very welcome. Definitely would recommend it</div>
							</div>
							<div class="comment">
			...
			<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 footer-matchheight">
				...
				<div class="footer-item-3-socials"> <a href="https://www.facebook.com/"><i class="fa fa-facebook"></i></a> <a href="#"><i class="fa fa-google-plus"></i></a> <a href="https://www.twitter.com/"><i class="fa fa-twitter"></i></a> <a href="https://www.skype.com/en/"><i class="fa fa-skype"></i></a> </div>
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 footer-copyright">
						<div> Copyright &copy; 2016 <a href="https://themeforest.net/item/dentalclinic-responsive-clinic-html-template/17390217" target="_blank">DentalClinic</a> Template by <a href="http://fvdthemes.com/" target="_blank">FVD Themes</a> </div>
					</div>
				</div>
			</div>
